...
class GPT2LMSegmentModel(GPT2LMHeadModel):
    """
    This class is use to override the prepare_inputs_for_generation of GPT2LMHeadModel
    --> the vanilla generate function from huggingface does not allow to specify the token type id of the input,
    because we need to give this information, we bypass it using prepare_inputs_for_generation
    """
    ...
    def prepare_inputs_for_generation(self, input_ids, past, **kwargs):
        assert self.p2_token is not None, \
            "set_special_tokens(tokenizer: GPT2Tokenizer) should be called once when initializing a GPT2LMSegmentModel."
